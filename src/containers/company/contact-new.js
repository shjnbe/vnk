        ...
        <Content>
          <Form>
            <Item floatingLabel>
              ...
              <Input value={this.state.name} onChangeText={value => this.handleChangeText('name', value)} disabled={disabled}/>
            </Item>
            <Item floatingLabel>
              <Label>Vị trí</Label>
