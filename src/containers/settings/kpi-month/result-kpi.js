...
export default props => {
  const salary = _.get(props, 'kpiConfig.salary', 0)
  ...
  const totalScore = _.sumBy(list, 'totalScore')
  const totalSalary = _.sumBy(list, 'salary')
  const totalBonus = totalSalary*bonus/100
  const per = _.round(totalScore / date_count / daily_score * 100, 0)
  return (
    <Wrapper>
      <Row>
